...
<body>
    ...
    <?php
    global $clink;
    $result_db = mysqli_query($clink, "SELECT COUNT(UserID) FROM report");
 ...
 <a class="page-link" href="report.php?page=' . ($page - 1) . '">Previous</a> 
  </li>';
    }
   ...
   <a class="page-link" href="report.php?page=' . $i . '">' . $i . '</a> 
    </li>';
    }
    if ($total_pages > $page) {
        echo '<li class="page-item ' . $active . ' ">
